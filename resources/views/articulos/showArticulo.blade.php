...
<div class="container">
  ...
  <div id="card3" class="card mb-3">
    <img class="card-img-top cardImg2" src="{{$articulo->imagen}}" alt="Card image cap">
    <div class="card-body">
      <h2 class="card-title">{{ $articulo->titulo }}</h2>
      <h5>{{ $articulo->descripcion }}</h5>
      <h4>{{ $nombreCategoria }}</h4>
      <h4><small class="text-muted"> Autor: {{ $nombre }}, fecha de publicación: {{ $articulo->updated_at }}</small></h4>
    </div>
    ...
    <div class="row" style="margin-left: 2vh; margin-bottom : 2vh;">
      ...
      <button class="btn btn-danger btn1">
        <a href="/destroyArticulo/{{ $articulo->idArt }}" data-toggle="tooltip" data-placement="top" title="borrar" style="color : white;">
      ...
      <button class="btn btn-info btn-sm btn1"  onclick="show()">
    ...
    @endif
      ...
      <button class="btn btn-success btn-sm btn1" onclick="show2()">
  ...
  <div class="col-md-12">
    ...
    <form id="form" class="col-md-12" action="{{ route('articulo.update',['idArt' => $articulo->idArt]) }}" method="POST" style="margin : 3vh; display : none;" enctype="multipart/form-data">
      @csrf
      <div class="row">
        <div class="col">
      ...
      <div class="row" style="margin-bottom : 2vh;">
        <div class="col-md-12">
          ...
          <textarea class="form-control" id="descripcion" rows="3" name="descripcion"required>{{ $articulo->descripcion}}</textarea>
        </div>
      </div>
      ...
      <div class="row">
        <div class="col">
          ...
          <input type="text" class="form-control" id="imagen" name="imagen" value="{{ $articulo->imagen}}"required>
        </div>
      ...
      <div class="row" style="margin-bottom : 2vh;">
        <div class="col-md-3">
          ...
          <select type="integer" class="form-control" id="idCat" name="idCat"required>
            <option value="{{ $articulo->idCat }}">{{ $nombreCategoria }}</option>
  ...
  <form id="form2" action="{{ route('comentarioArticulo.create') }}" method="POST" style="display : none;" enctype="multipart/form-data">
    @csrf
    <div class="row">
      <div class="col">
    ...
    <div class="row" style="display : none;">
      <div class="col-md-8">
        <label for="idArt">art</label>
        <input type="text" class="form-control" value="{{ $articulo->idArt }}" id="idArt" name="idArt"required>
      </div>
    </div>   
    ...
    <div class="col-md-8">
      <div class="media g-mb-30 media-comment">
        <div class="media-body u-shadow-v18 g-bg-secondary g-pa-30 comentario">
          <div class="g-mb-15">
            <h5 class="h5 g-color-gray-dark-v1 mb-0">{{ $comentario->idUsu}}</h5>
          ...
          <button class="btn btn-danger btn-lg btn1">
            <a href="/destroyComArticulo/{{ $comentario->id }}/{{ $articulo->idArt }}" data-toggle="tooltip" data-placement="top" title="borrar" style="color : white;">
              <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-trash" viewBox="0 0 16 16">
                <path d="M5.5 5.5A.5.5 0 0 1 6 6v6a.5.5 0 0 1-1 0V6a.5.5 0 0 1 .5-.5zm2.5 0a.5.5 0 0 1 .5.5v6a.5.5 0 0 1-1 0V6a.5.5 0 0 1 .5-.5zm3 .5a.5.5 0 0 0-1 0v6a.5.5 0 0 0 1 0V6z"/>
                <path fill-rule="evenodd" d="M14.5 3a1 1 0 0 1-1 1H13v9a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V4h-.5a1 1 0 0 1-1-1V2a1 1 0 0 1 1-1H6a1 1 0 0 1 1-1h2a1 1 0 0 1 1 1h3.5a1 1 0 0 1 1 1v1zM4.118 4L4 4.059V13a1 1 0 0 0 1 1h6a1 1 0 0 0 1-1V4.059L11.882 4H4.118zM2.5 3V2h11v1h-11z"/>
              </svg> Borrar
          ...
          <button class="btn btn-info btn-lg btn1" onclick="show3()">
            <svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-pencil-square" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
              <path d="M15.502 1.94a.5.5 0 0 1 0 .706L14.459 3.69l-2-2L13.502.646a.5.5 0 0 1 .707 0l1.293 1.293zm-1.75 2.456l-2-2L4.939 9.21a.5.5 0 0 0-.121.196l-.805 2.414a.25.25 0 0 0 .316.316l2.414-.805a.5.5 0 0 0 .196-.12l6.813-6.814z"/>
              <path fill-rule="evenodd" d="M1 13.5A1.5 1.5 0 0 0 2.5 15h11a1.5 1.5 0 0 0 1.5-1.5v-6a.5.5 0 0 0-1 0v6a.5.5 0 0 1-.5.5h-11a.5.5 0 0 1-.5-.5v-11a.5.5 0 0 1 .5-.5H9a.5.5 0 0 0 0-1H2.5A1.5 1.5 0 0 0 1 2.5v11z"/>
            </svg> Editar
              ...
              <form id="form3" action="{{ route('comentarioArticulo.update') }}" method="POST" enctype="multipart/form-data">
            @csrf
                <div class="row">
                        <div class="col">
