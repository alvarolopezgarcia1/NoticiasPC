...
<div class="container">
    ...
    <img class="card-img-top cardImg2" src="{{$noticia->imagen}}" alt="Card image cap">
    <div class="card-body">
      <h2 class="card-title">{{ $noticia->titulo }}</h2>
      <h5>{{ $noticia->descripcion }}</h5>
      <h4>{{ $nombreCategoria }}</h4>
      <h4><small class="text-muted"> Autor: {{ $nombre }}, fecha de publicación: {{ $noticia->updated_at }}</small></h4>
    </div>
...
@if((Auth::user()->rol == 1)||(Auth::user()->rol == 2))
   ...
   <button class="btn btn-danger btn-lg btn1" style="margin-right : 1vh;">
    ...
    <button class="btn btn-info btn-lg btn1" style="margin-right : 1vh;" onclick="show()">
...
@endif
 ...
 <button class="btn btn-success btn1" onclick="show2()">
    ...
    <form id="form2" action="{{ route('comentarioNoticia.create') }}" method="POST" style="display : none;" enctype="multipart/form-data">
            @csrf
                <div class="row">
                        <div class="col">
                 ...
                 <div class="row" style="display : none;">
                  ...
                  <div class="row" style="display : none;">
                        <div class="col-md-8">
                            <label for="idNot">not</label>
                            <input type="text" class="form-control" value="{{ $noticia->idNot }}" id="idNot" name="idNot"required>
                        </div>
                  </div>   
    ...
    <button class="btn btn-danger btn-lg" style="margin-right : 1vh;">
                    <a href="/destroyComNoticia/{{ $comentario->id }}/{{ $noticia->idNot }}" data-toggle="tooltip" data-placement="top" title="borrar" style="color : white;">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-trash" viewBox="0 0 16 16">
              <path d="M5.5 5.5A.5.5 0 0 1 6 6v6a.5.5 0 0 1-1 0V6a.5.5 0 0 1 .5-.5zm2.5 0a.5.5 0 0 1 .5.5v6a.5.5 0 0 1-1 0V6a.5.5 0 0 1 .5-.5zm3 .5a.5.5 0 0 0-1 0v6a.5.5 0 0 0 1 0V6z"/>
              <path fill-rule="evenodd" d="M14.5 3a1 1 0 0 1-1 1H13v9a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V4h-.5a1 1 0 0 1-1-1V2a1 1 0 0 1 1-1H6a1 1 0 0 1 1-1h2a1 1 0 0 1 1 1h3.5a1 1 0 0 1 1 1v1zM4.118 4L4 4.059V13a1 1 0 0 0 1 1h6a1 1 0 0 0 1-1V4.059L11.882 4H4.118zM2.5 3V2h11v1h-11z"/>
            </svg> Borrar
    ...
    <form id="form3" action="{{ route('comentarioNoticia.update') }}" method="POST" enctype="multipart/form-data">
            @csrf
                <div class="row">
                        <div class="col">
